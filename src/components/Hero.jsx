...
import { StarIcon } from "@heroicons/react/24/solid"; // FIXED: missing import

const Hero = ({ searchQuery }) => {  // FIXED: corrected destructuring
              ...
              >
                ...
                <div className="p-4 md:p-6">
                  <div className=" relative aspect-4/5 w-full rounded-xl md:rounded-2xl overflow-hidden bg-linear-to-br from-cyan-400/10 to-blue-400/10">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from bg-gray-900/80 via-transparent to-transparent" />
