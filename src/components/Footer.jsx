...
const Footer = () => {
  return (
    <footer className="relative bg-linear-to-b from-gray-900 to-gray-900/95 backdrop-blur-2xl border-t border-t-gray-800">
      {/* FLOATING PARTICLE */}
      <FloatingParticle />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 text-center sm:text-left">
            <h3 className="text-lg font-semibold bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
              Explore
            </h3>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          ...
          <p className="text-gray-500 text-sm mt-2">
            ...
            <a
              ...
              target="_blank"
              className="bg-clip-text text-transparent bg-linear-to-r from-purple-400 to-blue-400 hover:text-purple-400 transition-colors"
            >
